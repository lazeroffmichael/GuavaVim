  ...
  dependencies = {
    ...
    -- fancy UI for the debugger
    {
      ...
      config = function(_, opts)
        ...
        -- I don't want it to close automatticaly
    ...
    -- python debugging
    {
      ...
      config = function()
        -- Set the path to the base mason debupy installation
        local path = require("mason-registry").get_package("debugpy"):get_install_path()
        require("dap-python").setup(path .. "/venv/bin/python")

        -- Pytest as runner: by default it will usually just try to figure out by itself
